...
!function (t, a) {
    ...
    return i.prototype = {
        constructor: i, setStartDate: function (t) {
            ...
            var e = R(t.target).closest(".drp-calendar").hasClass("left"), a = e ? "left" : "right",
                i = this.container.find(".drp-calendar." + a), s = parseInt(i.find(".monthselect").val(), 10),
            ...
            var e = R(t.target).closest(".drp-calendar"), a = e.hasClass("left"),
