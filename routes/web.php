...
Route::group(['prefix' => 'admin', 'middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'rooms'], function () {
        ...
        Route::post('/add-category-special', 'Admin\RoomController@addToCategorySpecial')->name('Room.add.category.special');
    ...
    Route::group(['prefix' => 'news-block'], function () {
        Route::get('/', 'Admin\NewsBlockController@index')->name('newsBlock.index');
        Route::get('/show', 'Admin\NewsBlockController@show')->name('newsBlock.show');
        Route::get('/getData', 'Admin\NewsBlockController@getData')->name('newsBlock.getData');
        Route::post('/update', 'Admin\NewsBlockController@update')->name('newsBlock.update');
        Route::get('/edit', 'Admin\NewsBlockController@edit')->name('newsBlock.edit');
    });
    ...
    Route::group(['prefix' => 'contact-banner'], function () {
        Route::get('/', 'Admin\ContactBannerController@edit')->name('contactPages.edit');
        Route::post('/update', 'Admin\ContactBannerController@update')->name('contactPages.update');
    });
    ...
    Route::group(['prefix' => 'amenities'], function () {
        Route::get('/', 'Admin\AmenitiesController@index')->name('amenities.index');
        Route::get('/searchData', 'Admin\AmenitiesController@searchData')->name('amenities.searchData');
        Route::get('/{id}/show', 'Admin\AmenitiesController@show')->name('amenities.show');
        Route::get('/create', 'Admin\AmenitiesController@create')->name('amenities.create');
        Route::post('/', 'Admin\AmenitiesController@store')->name('amenities.store');
        Route::post('/{id}/update', 'Admin\AmenitiesController@update')->name('amenities.update');
        Route::get('/{id}/delete', 'Admin\AmenitiesController@delete')->name('amenities.delete');
        Route::get('/{id}/getDataForEdit', 'Admin\AmenitiesController@getDataForEdit');
        Route::get('/exportExcel','Admin\AmenitiesController@exportExcel')->name('amenities.exportExcel');
    });
